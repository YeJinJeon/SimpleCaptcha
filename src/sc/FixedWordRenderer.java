...
public class FixedWordRenderer implements WordRenderer {
	...
	private static final double YOFFSET = 0.3;
     ...
     * @param fonts
     */
    public FixedWordRenderer(List<Color> colors, List<Font> fonts) {
    ...
    public void render(final String word, BufferedImage image) {
        ...
        for (char c : word.toCharArray()) {
            ...
            if (chars[0] == '2' || chars[0] == '3' || chars[0] == '4' || chars[0] == '5' || chars[0] == '6' ||
            								chars[0] == '7' || chars[0] == '8' || chars[0] == '9') {
            	g.setColor(_colors.get(RAND.nextInt(_colors.size())));

                int choiceFont = RAND.nextInt(_fonts.size()-1);
